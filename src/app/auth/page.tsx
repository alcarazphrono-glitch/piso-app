  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      if (modo === "registro") {
        ...
        // Checkpoint 18-sep-2026 (hardening de seguridad, migración 0008):
        // perfil + balance ya no los crea el cliente -- los crea un
        // trigger en auth.users (manejar_nuevo_usuario()), atómico y sin
        // la ventana donde un cliente podía insertar su propio balance
        // inicial. Para cuando este código corre, esa fila ya existe.
      ...
      <div className="mt-8">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-3">
          <input
            ...
            className="rounded-card border border-line bg-surface px-4 py-3.5 text-[15px] text-ink outline-none placeholder:text-faint focus-visible:ring-2 focus-visible:ring-mint"
          />
          <input
            type="password"
            required
